...
<h2 class="fade-in">#### Habilidades Técnicas: Excel, PowerBI, Python, Java, C#, C++, JavaScript, GDScript, CSS,Blender, AutoCAD, Unity, Godot, SketchUp, Clip Studio Paint, Adobe Premiere, Adobe Photoshop, CorelDRAW, BitBar</h2>
<h2 class="fade-in">#### Idiomas: Português (Nativo) | Inglês (Fluente)</h2>

<h1 class="fade-in">## Educação</h1>
<ul class="fade-in">
...
<h1 class="fade-in">## Experiência Profissional</h1>
